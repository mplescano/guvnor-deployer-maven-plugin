 ...
 * @since 1.0.0
 */
class DroolsAddGeneratedGetMethodVisitor extends DroolsAbstractMethodVisitor {
	...
	public DroolsAddGeneratedGetMethodVisitor(MethodVisitor mv, 
			int access,
			String name, 
			String desc,
			String parent,
	...
	public void visitMaxs(int arg0, int arg1) {
		...
		else super.visitMaxs(arg0+1, arg1);
	}

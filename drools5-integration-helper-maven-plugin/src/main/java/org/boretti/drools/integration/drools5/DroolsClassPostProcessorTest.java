 ...
 * @author mbo
 * @since 1.0.0
 * @goal drools-postprocessor-test
 * @phase process-test-classes
 * @requiresDependencyResolution runtime
 */
public class DroolsClassPostProcessorTest extends AbstractMojo {

	@Override
	public void execute() throws MojoExecutionException, MojoFailureException {
		if (getLog().isDebugEnabled()) getLog().debug("starting drools post-compilation");
     ...
     *
     * @parameter expression="drools-postprocessor-test.xml"
     * @required
     * @since 1.1.0
     */
